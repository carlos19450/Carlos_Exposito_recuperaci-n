...
public class EjE4 {
    public static void main(String[] args) {
        ...
        //ARTICULO2
        System.out.println(articulo2.getNombre() +" - Precio: "+ articulo2.getPrecio() +" - IVA: "+ articulo2.getIva() + " - PVP " + articulo2.getPVP() + " - PVP con descuento: "+ articulo2.getPVPDescuento(articulo2.getPVP()));
        articulo2.vender(1);
        ...
        //ARTICULO3
        System.out.println(articulo3.getNombre() +" - Precio: "+ articulo3.getPrecio() +" - IVA: "+ articulo3.getIva() + " - PVP " + articulo3.getPVP() + " - PVP con descuento: "+ articulo3.getPVPDescuento(articulo3.getPVP()));
        articulo3.vender(1);
